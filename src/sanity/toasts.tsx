  ...
  switch (phase) {
    ...
    case 'Unauthorized':
      return {
        ...
        status: 'error',
        description:
          'Digital Ocean rejected the provided security token. Please check the configuration.',
        duration,
        closable: true,
      }
    case 'invalid_argument':
      return {
        ...
        status: 'error',
        description:
          'Digital Ocean cannot find an app with the provided ID. Please check the configuration.',
        duration,
        closable: true,
      }
    default:
